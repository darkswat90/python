...
email = input('Enter you emale address:')
...
if not match:
    print('Name is not begin capital letter!')

match = re.search(pattern, surname)

if not match:
    print('Surname is not begin capital letter!')

pattern = '[^a-z0-9_.@]'
match = re.search(pattern, email)

if match:
    print('Emale address have capital letter!')

pattern = '[a-z0-9_.]+@[0-9a-zA-Z]+\.(ru|org|com)'
match = re.search(pattern, email)
